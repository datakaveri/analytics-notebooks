...
# pune_air_quality documentation build
...
from pune_air_quality import __version__ as release

# -- Project information -----------------------------------------------------

project = "pune_air_quality"
author = "Kedro"
...
htmlhelp_basename = "pune_air_qualitydoc"
...
latex_documents = [
    (
        master_doc,
        "pune_air_quality.tex",
        "pune_air_quality Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "pune_air_quality",
        "Project pune_air_quality codebase.",
        "Data-Science",
    )
]
